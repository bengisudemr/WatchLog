...
// MARK: - AddMovieView
/// Yeni film veya dizi eklemek için form ekranı
struct AddMovieView: View {
    ...
    // MARK: - Save Function
    /// Yeni filmi kaydeder ve listeye ekler
    private func saveMovie() {
        // Görseli Data'ya çevir
        var imageData: Data? = nil
        if let image = selectedImage {
            imageData = image.jpegData(compressionQuality: 0.8)
        }
        
        // Yeni Movie nesnesi oluştur
        let newMovie = Movie(
...
#Preview {
    // Preview için geçici bir ViewModel oluştur
